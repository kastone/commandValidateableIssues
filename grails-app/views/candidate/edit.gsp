...
<html>
    ...
    <body>
        ...
        <div id="edit-candidate" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.candidate}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.candidate}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.candidate}" method="PUT">
                <g:hiddenField name="version" value="${this.candidate?.version}" />
                <fieldset class="form">
